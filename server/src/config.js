...
export const config = {
  ...
  groupConnections: Math.min(4, Math.max(2, Number(process.env.GROUP_WARM_CONNECTIONS) || 2)),
  groupWarmUpTimeoutMs: Math.max(1000, Number(process.env.GROUP_WARM_UP_TIMEOUT_MS) || 3000),
  botState,
  botStateFile,
